...
export default function ConfirmLogoutModal({ visible, onConfirm, onCancel, loading = false }: Props) {
  return (
      ...
      <View style={styles.overlay}>
        <View style={styles.container}>
          ...
          <View style={styles.buttonsRow}>
            ...
            <TouchableOpacity 
              style={[styles.button, styles.confirm, loading && styles.buttonDisabled]} 
              onPress={onConfirm}
              disabled={loading}
            >
              {loading ? (
...
const styles = StyleSheet.create({
  ...
  buttonDisabled: { backgroundColor: '#FCA5A5', opacity: 0.7 },
